...
class WP_Theme implements ArrayAccess
{
     ...
     * @var array
     */
    private array $headers_sanitized = [];
     ...
     * @var bool
     */
    private bool $textdomain_loaded;
     ...
     * @var bool
     */
    private static bool $persistently_cache;
     ...
     */
    public function parent(): static|false
    {
     ...
     */
    private function cache_add(string $key, array|string $data): bool
    {
     ...
     *                            False on failure.
     */
    public function display(string $header, bool $markup = true, bool $translate = true): string|array|false
    {
     ...
     */
    private function markup_header(string $header, string|array $value, string $translate): string
    {
        switch ($header) {
            case 'Name':
                if (empty($value)) {
     ...
     */
    public function get_files(array|string $type = null, int $depth = 0, bool $search_parent = false): array
    {
     ...
     */
    public function get_page_templates(?WP_Post $post = null, string $post_type = 'page'): array
    {
        if ($post) {
     ...
     */
    private static function scandir(string $path, array|string|null $extensions = null, int $depth = 0, string $relative_path = ''): array|false
    {
        if (!is_dir($path)) {
            return false;
        }
     ...
     */
    public static function get_core_default_theme(): static|false
    {
