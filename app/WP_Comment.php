...
class WP_Comment
{
     ...
     * @var bool
     */
    public bool $comment_approved = true;
     ...
     * @var bool
     */
    protected bool $populated_children = false;
     ...
     */
    public static function get_instance(int $id): static|false
    {
        global $wpdb;
     ...
     */
    public function get_child(int $child_id): static|false
    {
     ...
     */
    public function populated_children(bool $set): void
    {
