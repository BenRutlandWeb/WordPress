...
class WP_Http
{
     ...
     */
    public function request(string $url, string|array $args = []): array|WP_Error
    {
        $defaults = array(
            'method'              => 'GET',
            /**
     ...
     */
    public static function normalize_cookies(array $cookies): Requests_Cookie_Jar
    {
     ...
     */
    public static function browser_redirect_compatibility(string $location, array $headers, string|array $data, array &$options, Requests_Response $original): void
    {
     ...
     *                        A WP_Error instance upon error.
     */
    public function post(string $url, string|array $args = []): array|WP_Error
    {
     ...
     *                        A WP_Error instance upon error.
     */
    public function get(string $url, string|array $args = []): array|WP_Error
    {
     ...
     *                        A WP_Error instance upon error.
     */
    public function head(string $url, string|array $args = []): array|WP_Error
    {
     ...
     */
    public static function handle_redirects(string $url, array $args, array $response): array|false|WP_Error
    {
