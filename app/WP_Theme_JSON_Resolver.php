...
class WP_Theme_JSON_Resolver
{
     ...
     * @var array
     */
    protected static array $blocks_cache = [
        'core'   => [],
        'blocks' => [],
        'theme'  => [],
        'user'   => [],
     ...
     */
    protected static ?WP_Theme_JSON $core = null;
     ...
     * @var WP_Theme_JSON|null
     */
    protected static ?WP_Theme_JSON $blocks = null;
     ...
     * @var WP_Theme_JSON|null
     */
    protected static ?WP_Theme_JSON $theme = null;
     ...
     * @var bool
     */
    protected static ?bool $theme_has_support = null;
     ...
     * @var WP_Theme_JSON
     */
    protected static ?WP_Theme_JSON $user = null;
     ...
     * @var int
     */
    protected static ?int $user_custom_post_type_id = null;
     ...
     */
    protected static array|object|null $i18n_schema = null;
     ...
     * @var array
     */
    protected static array $theme_json_file_cache = [];
     ...
     */
    public static function get_fields_to_translate(): array
    {
     ...
     */
    protected static function translate(array $theme_json, string $domain = 'default'): array
    {
        if (null === static::$i18n_schema) {
            $i18n_schema         = wp_json_file_decode(WPINC . '/theme-i18n.json');
    ...
    public static function get_core_data(): WP_Theme_JSON
    {
        ...
        $config = static::read_json_file(WPINC . '/theme.json');
     ...
     */
    protected static function has_same_registered_blocks(string $origin): bool
    {
     ...
     */
    public static function get_theme_data(array $deprecated = [], array $options = []): WP_Theme_JSON
    {
        if (!empty($deprecated)) {
     ...
     */
    private static function remove_json_comments(array $array): array
    {
        unset($array['//']);
     ...
     */
    public static function get_user_data_from_wp_global_styles(WP_Theme $theme, bool $create_post = false, array $post_status_filter = ['publish']): array
    {
     ...
     * @return bool
     */
    public static function theme_has_support(): bool
    {
        if (!isset(static::$theme_has_support)) {
            static::$theme_has_support = (static::get_file_path_from_theme('theme.json') !== '' ||
     ...
     */
    protected static function get_file_path_from_theme(string $file_name, bool $template = false): string
    {
