...
class WP_User
{
     ...
     * @var array
     */
    private static array $back_compat_keys;
     ...
     */
    public function __construct($id = 0, string $name = '', int $site_id = 0)
    {
     ...
     */
    protected function _init_caps(string $cap_key = ''): void
    {
        global $wpdb;
     ...
     */
    public function for_blog(int $blog_id = 0): void
    {
        _deprecated_function(__METHOD__, '4.9.0', 'WP_User::for_site()');
     ...
     */
    private function get_caps_data(): array
    {
